...
//    }
        ...
        $('input[name=login]', target_elem).focus()

        return false;
    }


    //Event: Search filter click
...
//        $(document).ready(function() {
        ...
        $(".cclick_container.cfilter a").click(function() {
            ...
            //  $("#active_filter").removeClass();
            // $("#active_filter").addClass("active_filter roundTL4 active " + elC);

            $("#active_filter i").removeClass();
            $("#active_filter i").addClass(elC);

            $(".cclick_container a").show();
            $(".cclick_container a").removeClass("clicked");
           $(".cclick_container ." + elC).addClass("clicked");

           $(".cclick_container.cfilter").hide();
          $("#active_filter").css("background", "none");
            //alert ($("#active_filter").attr('class'));
        })
